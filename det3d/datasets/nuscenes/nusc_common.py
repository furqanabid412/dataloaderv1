...
def _fill_trainval_infos_nosweep(nusc,train_scenes, val_scenes, test=False, filter_zero=True):
...
def create_nuscenes_infos(root_path, version="v1.0-trainval", nsweeps=10, rate=1., filter_zero=True):
    ...
    if nsweeps>0:
        ...
        train_nusc_infos, val_nusc_infos = _fill_trainval_infos_nosweep(
            nusc, train_scenes, val_scenes, test, filter_zero=filter_zero)
